## This is a fork of [Autoscan](https://github.com/Cloudbox/autoscan/) that has been modified to work with Jellyfin 12.0. If you already had Autoscan set up through Docker Compose, simply replace `junkerino/autoscan` with `junkerino/autoscan` and it should function without issue.
